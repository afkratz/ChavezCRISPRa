...
def main():
    ...
    for i in range(len(bipartite_condition)):
        ...
        if not os.path.exists(os.path.join(ChavezCIRSPRa_root_dir,"screen_output","screen_results","processed_reads","bipartite_sorted")):
            os.mkdir(os.path.join(ChavezCIRSPRa_root_dir,"screen_output","screen_results","processed_reads","bipartite_sorted"))
        
        fqp.save_results(
            results,
            bipartite_rules,
            os.path.join(
                ChavezCIRSPRa_root_dir,"screen_output","screen_results","processed_reads","bipartite_sorted",
