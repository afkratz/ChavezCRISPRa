...
def main()->pd.DataFrame:
    ...
    for i in bipartite_activity_df.index:
        ...
        score = bipartite_activity_df.at[i,'CXCR4_average']
        construct_to_score[construct]=score

    ordered_activity= single_domain_activity_df.sort_values(by='CXCR4_average',ascending=False)['Construct'].to_list()
