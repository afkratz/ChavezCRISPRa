...
def main()->pd.DataFrame:
    ...
    for target in ['EPCAM','CXCR4','Reporter']:
        single_domain_scores['{}_average'.format(target)] = single_domain_scores[["{}_1".format(target),"{}_2".format(target)]].values.mean(axis=1)
    ...
    for target in ['EPCAM','CXCR4','Reporter']:
        bipartite_scores['{}_average'.format(target)] = bipartite_scores[["{}_1".format(target),"{}_2".format(target)]].values.mean(axis=1)
    ...
    for target in ['EPCAM','CXCR4','Reporter']:
        tripartite_scores['{}_average'.format(target)] = tripartite_scores[["{}_1".format(target),"{}_2".format(target)]].values.mean(axis=1)
