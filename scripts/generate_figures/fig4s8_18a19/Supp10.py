...
def main()->pd.DataFrame:
    ...
    single_domain_tox_df.sort_values(by='Average_Tox',inplace=True)
    ...
    bipartite_tox_df.sort_values(by='Average_Tox',inplace=True)
    ...
    tripartite_tox_df.sort_values(by='Average_Tox',inplace=True)
    ...
    res =pd.concat((
        ...
        'EPCAM and CXCR4 average':single_domain_tox_df['Average_Tox'],
    }),
    pd.DataFrame({
        ...
        'EPCAM and CXCR4 average':bipartite_tox_df['Average_Tox'],
    }),
    pd.DataFrame({
        ...
        'EPCAM and CXCR4 average':tripartite_tox_df['Average_Tox'],
    })),
    ignore_index=True)
