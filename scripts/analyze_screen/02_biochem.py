...
for i in range(len(df_1)):
    for col in ['EPCAM_1','EPCAM_2','CXCR4_1','CXCR4_2','Reporter_1','Reporter_2','EPCAM_average','CXCR4_average','Reporter_average']:
...
df_1.to_csv(
        ...
        "screen_analysis",
        "biochem_analysis",
        "single_domain_screen_biochem_charachterized_.csv")
    )
...
df_2.to_csv(
        ...
        "screen_analysis",
        "biochem_analysis",
        "bipartite_screen_biochem_charachterized_.csv")
    )
df_3.to_csv(
        os.path.join(
        "output",
        "screen_analysis",
        "biochem_analysis",
        "tripartite_screen_biochem_charachterized_.csv")
    )