...
for df in p1_score,p2_score,p3_score:
    ...
    sst.calculate_zscore(df,"EPCAM_average","EPCAM_Score_Zscore")
    sst.calculate_zscore(df,"CXCR4_average","CXCR4Score_Zscore")
    sst.calculate_zscore(df,"Reporter_average","Reporter_Score_Zscore")
...
p1_score.to_csv(
    os.path.join(
        ...
        "screen_results",
        "screen_scores",
        "single_domain_screen_scored_with_zscore.csv"
    ),
    index=False
)
...
p2_score.to_csv(
    os.path.join(
        ...
        "screen_results",
        "screen_scores",
        "bipartite_screen_scored_with_zscore.csv"
    ),
    index=False
)
...
p3_score.to_csv(
    os.path.join(
        ...
        "screen_results",
        "screen_scores",
        "tripartite_screen_scored_with_zscore.csv"
    ),
    index=False
)