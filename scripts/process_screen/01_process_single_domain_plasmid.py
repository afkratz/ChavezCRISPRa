...
def main():
    ...
    for i in range(len(single_domain_condition)):
        ...
        if not os.path.exists(os.path.join("output","screen_results","processed_reads","single_domain_plasmid")):
            os.mkdir(os.path.join("output","screen_results","processed_reads","single_domain_plasmid"))
        
        fqp.save_results(results,
                         single_domain_rules,
                         os.path.join(
                            "output","screen_results","processed_reads","single_domain_plasmid",
